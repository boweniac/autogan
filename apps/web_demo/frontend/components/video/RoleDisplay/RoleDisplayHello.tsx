...
import VideoScene from "@/components/avatar/Scene/VideoScene";
...
export default function RoleDisplayHello() {
    const avatarList = ["customerManagerBoy", "customerManagerGirl", "coder", "documentExp", "searchExpert", "secretary"]
  ...
  useEffect(() => {
    ...
    return (
        ...
        >
            ...
            <VideoScene avatarName={avatarName} animation="video1" test={true} animationPlayEndCallback={()=>{
