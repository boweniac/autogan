...
const GLBModel: React.FC<GLBModelProps> = ({ modelPath, animationPath, morphTargetName, audioAndLip, lipValue }) => {
    ...
    useEffect(() => {
      if (lipValue) {
        ...
        if (headNode instanceof THREE.Mesh && headNode.morphTargetDictionary && headNode.morphTargetInfluences) {
          const headTargetIndex = headNode.morphTargetDictionary[corresponding[lipValue]];
        ...
        if (teethNode instanceof THREE.Mesh && teethNode.morphTargetDictionary && teethNode.morphTargetInfluences) {
          const teethTargetIndex = teethNode.morphTargetDictionary[corresponding[lipValue]];
...
const DefaultAvatar: React.FC<DefaultAvatarProps> = ({ morphTargetName, audioAndLip, lipValue }) => {
  ...
  return (
    <div style={{height: "100%", width: "100%"}}>
      <Canvas gl={{ alpha: true }}>
        ...
        <GLBModel modelPath="/avatar/default.glb" animationPath="/animations/default.fbx" morphTargetName={morphValue} audioAndLip={audioAndLip}  lipValue={lipValue}/>
        <CameraController  />
